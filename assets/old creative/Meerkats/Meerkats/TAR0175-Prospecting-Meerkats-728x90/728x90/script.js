...
function frame1(){
	...
	.set( [t1a,t1b,t2a,t2b], { y: 10 })
	.set( [end_logo, end_txt, cta ], { y: 20 })
	
	
	
	.add('start', 0 )
	.to( bg_img, 8, { y:0, x:0, transformOrigin:'100% 0%'  }, "start")
	...
	.to( t2a, 1, { alpha: 1, y:0, ease: animTypeOut }, "t2+=0.5")
	.to( t2b, 1, { alpha: 1, y:0, ease: animTypeOut }, "t2+=0.75")
	
	
	.add( "endFade", "t2+=3" )
	.to( t2a, 1, { alpha: 0, y:animOffsetDist, ease: animTypeIn }, "endFade+=0")
	.to( t2b, 1, { alpha: 0, y:animOffsetDist, ease: animTypeIn }, "endFade+=0")
	
	
	.add( "endframe", "endFade+=1" )
